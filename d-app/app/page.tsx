...
export default async function Home() {
  ...
  return <>
    ...
    <div id="main">
      ...
      <p>If you're the first to claim a <span className="gold">Hunt goal</span>, you'll win a cashprize !</p>
      ...
      <p className="more-margin">If you'd like to join the hunt, you can head to <a href="join" className="blue">Join the Hunt</a> page.</p>
      <p>When you find a goal, you can claim a prize in <a href="goals" className="blue">Claim a Hunt Goal</a> page.</p>
